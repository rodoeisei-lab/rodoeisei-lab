...
<section class="topic-hub__section chemical-section" aria-labelledby="reform-title"><div class="topic-hub__heading chemical-section-heading"><p class="topic-hub__label chemical-section-label">施行前の制度</p><h2 id="reform-title">2026年10月1日の制度改正</h2></div>
<aside class="topic-hub__notice chemical-disclaimer"><strong>2026年8月11日時点では施行予定です</strong><p>公表済みの改正では、2026年10月1日から個人ばく露測定が作業環境測定の一部として法令上明確に位置づけられ、指定作業場等で行う測定の実施者要件などが定められます。これは、すべての自主的な個人ばく露測定を一律に同じ資格者だけが行うという意味ではありません。測定目的、対象作業場、根拠条文ごとに要件を確認してください。</p></aside></section>
