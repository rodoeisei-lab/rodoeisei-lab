---
title: 化学物質管理を基礎から学ぶ
description: 職場の化学物質管理について、ラベル・SDSの確認、リスクアセスメント、リスク低減措置、ばく露管理、保護具、法令確認までを実務の流れに沿って整理します。
eyebrow: 化学物質管理
lead: 化学物質の把握からリスクアセスメント、対策、記録、見直しまでを順番に確認するための入口です。
...
<div class="topic-hub topic-hub--chemical chemical-hub">
  ...
  <section class="topic-hub__section chemical-section" aria-labelledby="chemical-flow-title">
    ...
    <ol class="topic-hub__steps chemical-steps">
      ...
      <li><span class="chemical-step-number">05</span><span><strong><a href="{{ '/guides/chemical-risk-assessment-basics/' | relative_url }}">リスクアセスメント</a></strong><small><a href="{{ '/guides/create-simple-guide/' | relative_url }}">CREATE-SIMPLEなどの支援ツール</a>も活用し、健康障害と火災・爆発などの危険性を評価する</small></span></li>
  ...
  <section class="topic-hub__section chemical-section" aria-labelledby="official-title">
    ...
    <div class="topic-hub__links chemical-official-links">
      ...
      <a href="https://anzeninfo.mhlw.go.jp/anzen/gmsds/gmsds640.html"><strong>ラベル・SDS対象物質検索</strong><span>対象物質とモデルSDSを検索</span></a>
      <a href="https://anzeninfo.mhlw.go.jp/user/anzen/kag/ankgc07_3.htm"><strong>CREATE-SIMPLE</strong><span>リスクアセスメント支援ツール</span></a>
      <a href="https://www.mhlw.go.jp/stf/newpage_32871.html"><strong>濃度基準値</strong><span>厚生労働省の告示・関連資料</span></a>
      <a href="https://elaws.e-gov.go.jp/"><strong>e-Gov法令検索</strong><span>法令の現行条文を確認</span></a>
    </div>
  </section>
